...
// faces (water, roads, leaves, roofs) sample a 2D array texture
...
void main() {
    ...
    //
    // The alpha is the face's opacity. The opaque pipeline ignores it
    // (blending disabled); the alpha pipeline blends with it.
